...
class ModuleMd5CrackTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$this -> oShell -> parseCommand( ':md5crack e10adc3949ba59abbe56e057f20f883e' );
		$this -> assertSame( "e10adc3949ba59abbe56e057f20f883e:123456\r\n", $this -> oModule -> get() );

		$this -> oShell -> parseCommand( ':md5crack ffffffffffffffffffffffffffffffff' );
		$this -> assertSame( "ffffffffffffffffffffffffffffffff:password-not-found\r\n", $this -> oModule -> get() );

		$this -> oShell -> parseCommand( ':md5crack 25f9e794323b453885f5181f1b624d0b 7ac66c0f148de9519b8bd264312c4d64 f6fdffe48c908deb0f4c3bd36c032e72' );
	...
	{
		$this -> oShell -> parseCommand( ':md5crack fffffffffffffffffffffffffffffffffffff' );
